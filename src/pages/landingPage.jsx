...
import FeatureCardContainer from '../components/landing/CardContainer'; 
            ...
            <div className="container">
                ...
                <div className="hero-container">
                    <div className='main'>
                        ...
                        <h2 className='subheader'>
                            <span className='sub-header'>
                               Dive Deeper into Anime & Manga
                            </span>
                        </h2>
                        <p className='description'>
                        A simple and convenient browser platform for AniList fans, where you can track, discover, and dive deeper into your favorite anime and manga like never before.
                        </p>
                        <div className="action">
                            ...
                            <p className='action'>
                               <a className='button-secondary'>Documentation</a>
                            </p>
                        </div>
                    </div>
                    {/* logo */}
                    <div className='main-img'>
                            <div className='img-container'>
                                <svg fill="var(--primary-color)" height="248px" width="248px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 462.83 462.83" xmlnsXlink="http://www.w3.org/1999/xlink" enableBackground="new 0 0 462.83 462.83">
                ...
                <div className='feature-container'>
                    <div className='feature-title'>
                        <span className='sub-header'>What does .tsubaki do?</span>
                    </div>
                    <div className='feature-subheader'>
                        <span>Here's what it does!</span>
                    </div>
